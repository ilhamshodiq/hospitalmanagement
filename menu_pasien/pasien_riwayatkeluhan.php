...
<body>
    ...
    $sql = "SELECT * FROM keluhan WHERE id_pasien = '$id_pasien' AND  status = 'belum disetujui'";
    $sql = "SELECT * FROM keluhan, dokter WHERE keluhan.id_pasien = '$id_pasien' AND keluhan.status = 'belum disetujui' AND keluhan.id_dokter = dokter.id_dokter";
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div class="" id="sidebar-wrapper" style="background-color: #5a636b;">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="pasien_riwayatkeluhan.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-clipboard-list me-2"></i></i>Riwayat Keluhan</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Riwayat Keluhan</h2>
                </div>
            </nav>
