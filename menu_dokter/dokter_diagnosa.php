...
<body>
    ...
    $sql = "SELECT * FROM diagnosa, keluhan WHERE diagnosa.id_keluhan = keluhan.id_keluhan AND keluhan.id_dokter = $id_dokter";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Riwayat Diagnosa</h2>
                </div>
            </nav>
