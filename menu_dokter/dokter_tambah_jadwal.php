    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <form action="aksi/aksi_tambahjadwal.php" method="post">
                    <!--lempar id_dokter hidden-->
                    <input type="hidden" name="id_dokter" value="<?php echo $id_dokter ?>">
                    <div class="mb-3">
                        <label for="inputwaktumulai" class="form-label">Waktu Mulai</label>
                        <input type="time" class="form-control" id="inputwaktumulai" name="waktu_mulai">
                    </div>
                    <div class="mb-3">
                        <label for="inputwaktuberakhir" class="form-label">Waktu Berakhir</label>
                        <input type="time" class="form-control" id="inputwaktuberakhir" name="waktu_berakhir">
                    </div>
