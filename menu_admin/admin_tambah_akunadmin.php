    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="list-group list-group-flush my-3">
                ...
                <a class="navbar-toggler list-group-item list-group-item-action bg-transparent second-text fw-bold nav-link dropdown-toggle second-text fw-bold active" href="#" id="accountDropdown" role="button" data-bs-toggle="dropdown">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Tambah Akun Admin</h2>
                </div>
            </nav>
            <div class="container-sm">
                <hr class="border-light border-2 opacity-75">
                <form action="aksi/aksi_tambahakunadmin.php" method="post">
                    <div class="mb-3">
                        <label for="inputusername" class="form-label">Username</label>
                        <input type="text" class="form-control" id="inputusername" name="username_admin">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputnamaadmin" name="nama_admin">
                    </div>
