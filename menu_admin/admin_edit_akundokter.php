...
<body>
    ...
    // $sql2 = "SELECT * FROM dokter WHERE username = '$username'";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Akun Dokter</h2>
                </div>
            </nav>
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            <div class="mb-3">
                                <label for="inputnamadokter" class="form-label">Nama Dokter</label>
                                <input type="text" class="form-control" id="inputnamadokter" name="nama_dokter" value="<?php echo $data2['nama_dokter'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputkelamin" class="form-label">Jenis Kelamin</label>
                                <select class="form-select" id="inputkelamin" name="jenis_kelamin" value="<?php echo $data2['jenis_kelamin'] ?>">
                                    <option value="Laki-laki">Laki-laki</option>
                                    <option value="Perempuan">Perempuan</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="inputspesialis" class="form-label">Spesialis</label>
                                <input type="text" class="form-control" id="inputspesialis" name="spesialis" value="<?php echo $data2['spesialis'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputpoliklinik" class="form-label">Poliklinik</label>
                                <select class="form-select" id="inputpoliklinik" name="id_poliklinik" value="<?php echo $data2['id_poliklinik'] ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="inputalamat" name="alamat" value="<?php echo $data2['alamat'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputusername" class="form-label">Username</label>
                                <input type="text" class="form-control" id="inputusername" name="username" value="<?php echo $data2['username'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputpassword" class="form-label">Password</label>
                                <input type="password" class="form-control" id="inputpassword" name="password" value="<?php echo $data2['password'] ?>">
                            </div>
                            <input class="btn btn-primary" type="submit" name="edit" value="Edit">
                            <a class="btn btn-danger" href="admin_akundokter.php" role="button">Cancel</a>
                        </form>
                <?php
                    }
                }
                if (isset($_POST['edit'])) {
                    ...
                    $sql = "UPDATE dokter SET nama_dokter='$nama_dokter', jenis_kelamin='$jenis_kelamin', spesialis='$spesialis', id_poliklinik='$id_poliklinik', alamat='$alamat', username='$username', password='$password' WHERE id_dokter='$id_dokter'";
                    $query = $koneksi->query($sql);
                    if ($query) {
