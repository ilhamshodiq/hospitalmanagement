...
<body>
    ...
    session_start();
    include "../koneksi.php";
    $sql = "SELECT * FROM dokter, poliklinik WHERE dokter.id_poliklinik = poliklinik.id_poliklinik";
    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="admin_tambah_akundokter.php" role="button">Tambah</a>
                    ...
                    <tbody>
                        <?php while ($data = $query->fetch_array()) { ?>
                            <tr>
                                ...
                                <td>
                                    <form action="admin_edit_akundokter.php?id_dokter=<?php echo $data['id_dokter'] ?>" method="post">
                                        <input type="hidden" name="username">                                      
                                        <input class="btn btn-success btn-sm" type="submit" value="edit">
                                    </form>
                                    <p></p>
                                    <form action="aksi/aksi_hapusdokter.php" method="post">
