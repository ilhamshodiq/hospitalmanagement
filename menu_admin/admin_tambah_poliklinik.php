        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Tambah Poliklinik</h2>
                </div>
            </nav>
            <div class="container-sm">
                <hr class="border-light border-2 opacity-75">
                <form action="aksi/aksi_tambahpoliklinik.php" method="post">
                    <div class="mb-3">
                        <label for="inputnamapoliklinik" class="form-label">Nama Poliklinik</label>
                        <input type="text" class="form-control" id="inputnamapoliklinik" name="nama_poliklinik">
                    </div>
                    <div class="mb-3">
                        <label for="inputdeskripsi" class="form-label">Deskripsi</label>
                        <textarea class="form-control" placeholder="Deskripsi Poliklinik" id="floatingTextarea" name="deskripsi"></textarea>
                    </div>
