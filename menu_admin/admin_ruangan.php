        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Ruangan</h2>
                </div>
            </nav>
            <div class="container-sm">
                <hr class="border-light border-2 opacity-75">
                <a class="btn btn-primary mb-2 btn-sm" href="admin_tambah_ruangan.php" role="button">Tambah</a>
                    ...
                    <tbody>
                        <?php while ($data = $query->fetch_array()) { ?>
                            <tr>
                                ...
                                <td>
                                    <form action="admin_edit_ruangan.php?id_ruangan=<?php echo $data['id_ruangan'] ?>" method="post">
                                        <input type="hidden" name="nama_ruangan">
                                        <input class="btn btn-success btn-sm" type="submit" value="edit">
                                    </form>
                                    <p></p>
                                    <form action="aksi/aksi_hapusruangan.php" method="post">
                                        <input type="hidden" name="nama_ruangan" value="<?php echo $data['nama_ruangan'] ?>">
                                        <input class="btn btn-danger btn-sm" type="submit" name="hapus" value="hapus" onClick="return confirm('Apakah Anda ingin menghapus obat?')">
                                    </form>
                                </td>
                            </tr>
                        <?php } ?>
...
<div id="page-content-wrapper">
    ...
    <div class="container-sm">
        ...
        ?>
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputnamaobat" name="nama_obat" value="<?php echo $data['nama_obat'] ?>">
                    </div>
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <label for="inputharga" class="form-label">Harga</label>
                            <input type="text" class="form-control" id="inputharga" name="harga" value="<?php echo $data['harga'] ?>">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="inputstok" class="form-label">Stok</label>
                            <input type="number" class="form-control" id="inputstok" name="stok" value="<?php echo $data['stok'] ?>">
                        </div>
                    </div>
        ...
        if (isset($_POST['edit'])) {
            ...
            $harga = $_POST['harga'];
            $stok = $_POST['stok'];
            $sql = "UPDATE obat SET nama_obat = '$nama_obat', harga = '$harga', stok = '$stok' WHERE nama_obat = '$nama_obat'";
            $query = $koneksi->query($sql);
            if ($query) {
