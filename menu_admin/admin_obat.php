    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="admin_obat.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-pills me-2"></i>Obat</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="admin_tambah_obat.php" role="button">Tambah</a>
                <table class="table table-light table-striped rounded table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" width="150">Stok</th>
                    ...
                    <tbody>
                        <?php while ($data = $query->fetch_array()) { ?>
                            <tr>
                                ...
                                <td>
                                    <form action="admin_edit_obat.php?id_obat=<?php echo $data['id_obat']?>" method="post">
                                        <input type="hidden" name="nama_obat">
                                        <input class="btn btn-success btn-sm" type="submit" value="edit">
                                    </form>                                    
                                    <p></p>
                                    <form action="aksi/aksi_hapusobat.php" method="post">
                                        <input type="hidden" name="nama_obat" value="<?php echo $data['nama_obat'] ?>">
