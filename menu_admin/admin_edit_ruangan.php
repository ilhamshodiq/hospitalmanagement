        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Edit Ruangan</h2>
                </div>
            </nav>
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="inputnamaruangan" name="nama_ruangan" value="<?php echo $data['nama_ruangan'] ?>">
                            </div>
                            <input class="btn btn-primary" type="submit" name="edit" value="Edit">
                            <a class="btn btn-danger" href="admin_ruangan.php" role="button">Cancel</a>
                        </form>
                <?php
                    }
                }
                if(isset($_POST['edit'])){
                    ...
                    $sql = "UPDATE ruangan SET nama_ruangan = '$nama_ruangan' WHERE id_ruangan = '$id_ruangan'";
                    $query = $koneksi->query($sql);
                    if ($query) {
