            ...
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                <label for="inputnamaadmin" class="form-label">Nama Admin</label>
                                <input type="text" class="form-control" id="inputnamaadmin" name="nama_admin" value="<?php echo $data['nama_admin'] ?>">
                            </div>
                            <input class="btn btn-primary" type="submit" name="edit" value="Edit">
                            <a class="btn btn-danger" href="admin_akunadmin.php" role="button">Cancel</a>
                        </form>
                <?php
                    }
                }
                if (isset($_POST['edit'])) {
                    ...
                    $sql = "UPDATE admin SET username = '$username', password = '$password', nama_admin = '$nama_admin' WHERE id_admin = '$id_admin'";
                    $query = $koneksi->query($sql);
                    if ($query) {
