        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="inputnamapasien" name="nama_pasien" value="<?php echo $data['nama_pasien'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputkelamin" class="form-label">Jenis Kelamin</label>
                                <select class="form-select" id="inputkelamin" name="jenis_kelamin" value="<?php echo $data['jenis_kelamin'] ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="inputalamat" name="alamat" value="<?php echo $data['alamat'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputnohp" class="form-label">No HP</label>
                                <input type="text" class="form-control" id="inputnohp" name="no_hp" value="<?php echo $data['no_hp'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputusername" class="form-label">Username</label>
                                <input type="text" class="form-control" id="inputusername" name="username" value="<?php echo $data['username'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputpassword" class="form-label">Password</label>
                                <input type="password" class="form-control" id="inputpassword" name="password" value="<?php echo $data['password'] ?>">
                            </div>
                            <input class="btn btn-primary" type="submit" name="edit" value="Edit">
                            <a class="btn btn-danger" href="admin_akunpasien.php" role="button">Cancel</a>
                        </form>
                <?php
                    }
                }
                if(isset($_POST['edit'])){
                    ...
                    $sql = "UPDATE pasien SET nama_pasien='$nama_pasien', jenis_kelamin='$jenis_kelamin', alamat='$alamat', no_hp='$no_hp', username='$username', password='$password' WHERE id_pasien='$id_pasien'";
                    $query = $koneksi->query($sql);
                    if ($query) {
