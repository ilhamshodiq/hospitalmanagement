...
<body>
    ...
    $sql = "SELECT * FROM poliklinik WHERE id_poliklinik = '$id_poliklinik'";
    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="list-group list-group-flush my-3">
                <a href="admin_dashboard.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-home me-2"></i>Dashboard</a>
                ...
                <a href="admin_poliklinik.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-house-medical-flag me-2"></i>Poliklinik</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Edit Poliklinik</h2>
                </div>
            </nav>
            <?php
            ...
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            <div class="mb-3">
                                <label for="inputnamapoliklinik" class="form-label">Nama Poliklinik</label>
                                <input type="text" class="form-control" id="inputnamapoliklinik" name="nama_poliklinik" value="<?php echo $data['nama_poliklinik'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="inputdeskripsi" class="form-label">Deskripsi</label>
                                <input type="text" class="form-control" id="inputdeskripsi" name="deskripsi" value="<?php echo $data['deskripsi'] ?>">
                            </div>
                            <input class="btn btn-primary" type="submit" name="edit" value="Edit">
                            <a class="btn btn-danger" href="admin_poliklinik.php" role="button">Cancel</a>
                        </form>
                <?php
                    }
                }
                if (isset($_POST['edit'])) {
                    ...
                    $sql = "UPDATE poliklinik SET nama_poliklinik = '$nama_poliklinik', deskripsi = '$deskripsi' WHERE nama_poliklinik = '$nama_poliklinik'";
                    $query = $koneksi->query($sql);
                    if ($query) {
