        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Poliklinik</h2>
                </div>
            </nav>
            <div class="container-sm">
                <hr class="border-light border-2 opacity-75">
                <a class="btn btn-primary mb-2 btn-sm" href="admin_tambah_poliklinik.php" role="button">Tambah</a>
                <table class="table table-light table-striped rounded table-hover">
                    <thead>
                        <tr>
                            <th scope="col" width="50">#</th>
                            <th scope="col" width="150">Nama Poliklinik</th>
                    ...
                    <tbody>
                        <?php while ($data = $query->fetch_array()) { ?>
                            <tr>
                                ...
                                <td>
                                    <form action="admin_edit_poliklinik.php" method="post">
                                        <input type="hidden" name="id_poliklinik" value="<?php echo $data['id_poliklinik'] ?>">
                                        <input class="btn btn-success btn-sm" type="submit" value="edit">
                                    </form>
                                    <p></p>
                                    <form action="aksi/aksi_hapuspoliklinik.php" method="post">
                                        <input type="hidden" name="nama_poliklinik" value="<?php echo $data['nama_poliklinik'] ?>">
                                        <input class="btn btn-danger btn-sm" type="submit" name="hapus" value="hapus" onClick="return confirm('Apakah Anda ingin menghapus poliklinik?')">
                                    </form>
                                </td>
                            </tr>
                        <?php } ?>
