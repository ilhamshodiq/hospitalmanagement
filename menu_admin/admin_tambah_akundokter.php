    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="list-group list-group-flush my-3">
                ...
                <a class="active navbar-toggler list-group-item list-group-item-action bg-transparent second-text fw-bold nav-link dropdown-toggle second-text fw-bold active" href="#" id="accountDropdown" role="button" data-bs-toggle="dropdown">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Tambah Akun Dokter</h2>
                </div>
            </nav>
            <div class="container-sm">
                <hr class="border-light border-2 opacity-75">
                <form action="aksi/aksi_tambahakundokter.php" method="post">
                    <div class="mb-3">
                        <label for="inputnamadokter" class="form-label">Nama Dokter</label>
                        <input type="text" class="form-control" id="inputnamadokter" name="nama_dokter">
                    </div>
                    <div class="mb-3">
                        <label for="inputkelamin" class="form-label">Jenis Kelamin</label>
                        <select class="form-select" id="inputkelamin" name="jenis_kelamin">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputspesialis" name="spesialis">
                    </div>
                    <div class="mb-3">
                        <label for="inputpoliklinik" class="form-label">Poliklinik</label>
                        <select class="form-select" id="inputpoliklinik" name="id_poliklinik">
